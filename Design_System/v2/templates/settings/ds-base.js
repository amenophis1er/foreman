...
(() => {
  const base = '../..';
  for (const p of ["tokens/fonts.css","tokens/colors.css","tokens/typography.css","tokens/space-shape.css","tokens/motion.css","tokens/semantic.css","tokens/base.css","styles.css"]) {
    const l = document.createElement('link');
    l.rel = 'stylesheet'; l.href = base + '/' + p;
    document.head.appendChild(l);
  }
  const lucide = document.createElement('script');
  lucide.src = 'https://unpkg.com/lucide@0.460.0/dist/umd/lucide.min.js';
