    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: 'var(--sp-4)', flexWrap: 'wrap' }}>
        ...
        <Field layout="stacked" label="Director" hint="Plans, delegates, verifies.">
          <ModelSelect value={directorModel} onChange={setDirectorModel} models={models} loading={modelsLoading} note={modelsNote} inheritNote={modelsInheritNote} />
        </Field>
        <Field layout="stacked" label="Workers" hint="Implement. Cheaper models cut cost.">
          <ModelSelect value={workerModel} onChange={setWorkerModel} models={models} loading={modelsLoading} note={modelsNote} inheritNote={modelsInheritNote} />
        </Field>
